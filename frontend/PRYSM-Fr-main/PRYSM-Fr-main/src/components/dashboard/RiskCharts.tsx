...
const severityData = [
  ...
  { name: 'High', value: 28, color: '#f97316' },     // Orange
  { name: 'Medium', value: 45, color: '#eab308' },   // Yellow
  { name: 'Low', value: 30, color: '#3b82f6' },      // Blue
];

const domainData = [
  { name: 'Tax', risks: 42 },
  { name: 'Vendor', risks: 28 },
  { name: 'Payroll', risks: 15 },
  { name: 'Contracts', risks: 20 },
  { name: 'IT Security', risks: 10 },
];
    ...
    <ResponsiveContainer width="100%" height="100%">
      <PieChart>
        ...
        <Pie
          ...
          activeShape={false}
        >
          <Cell fill="url(#pieCritical)" />
          <Cell fill="url(#pieHigh)" />
          <Cell fill="url(#pieMedium)" />
          <Cell fill="url(#pieLow)" />
        </Pie>
        <RechartsTooltip 
